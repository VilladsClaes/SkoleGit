...
namespace JavaScriptJQuery.Controllers
{
    public class JavaScriptController : Controller
    {
        ...
        public ActionResult Opg11()
        {
            return View();

        }
        public ActionResult Opg12()
        {
            return View();

        }
        public ActionResult Opg13()
        {
            return View();

        }
        public ActionResult Opg14()
        {
            return View();

        }
        public ActionResult Opg15()
        {
            return View();

        }
        public ActionResult Opg16()
        {
            return View();

        }
        public ActionResult Opg17()
        {
            return View();

        }
        public ActionResult fotogalleri()
        {
            return View();
