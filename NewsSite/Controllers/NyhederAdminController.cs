...
namespace NewsSite.Controllers
{
    ...
    public class NyhederAdminController : Controller
    {
       ...
       //OPRET NYHED - tag tidspunktet med via Datetime
        ...
        {
            //Hvad gør den her??
            //HttpPostedFileBase NyhederImage = Request.Files["Nyheder.Photo"];
...

        {
            ...
            //
            //NyhedRettes.NyhedsKategoriListe = db.NyhedsKategoriTabel.ToList();
        ...
        //Sletter filen igen
        public ActionResult SletFilen(string stienpaabilledet)
        {
            IOTools.DelFile("~/Uploads/" + stienpaabilledet);
